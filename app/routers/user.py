...
from app.middlewares.auth import get_current_user, admin_required
...
def update_user_role(user_id: UUID, role: str, db: Session = Depends(get_db), current_admin: User = Depends(admin_required)):
